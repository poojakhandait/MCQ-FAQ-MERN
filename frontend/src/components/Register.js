...
const Register=()=> {
  ...
  let [data,setData]=useState({"_id":"","pwd":"","name":"","phone":""})
...
let add=()=>{
  axios.post("http://localhost:5000/userr",data).then((res)=>{
  ...
  return (
    <div className='regcon'>
      <div className='regform'>
        ...
        <input type='text' placeholder='write your phone number' name='phone' value={data.phone} onChange={fun}/>
